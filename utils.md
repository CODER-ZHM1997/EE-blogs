...
[快捷键大全](https://support.microsoft.com/zh-cn/microsoft-edge/microsoft-edge-%E4%B8%AD%E7%9A%84%E9%94%AE%E7%9B%98%E5%BF%AB%E6%8D%B7%E6%96%B9%E5%BC%8F-50d3edab-30d9-c7e4-21ce-37fe2713cfad)
...
- 正确格式：**5A A5 05 82 1000 0001**
  - 如果需要指定写入多个字节的话，直接后面补充就行了
    - **5A A5 05 82 1000 0001 0002**
- 错误格式：5A A5 06 82 10 00  01 00 01
  - 不需要指定字长度
...
- 最好是由主机告诉显示屏是否操作成功
  - 比如操作成功，主机就要通过uart往指定地址写入数据，这样图标状态才会更新
...
可以做，但是非常麻烦，因为我们不只是控制1个字，要控制多个字
...
- 最耗时的环节：产品设计+素材制作
- 点阵数需要为偶数，而且不能过大
- 它的F屏幕是8MB的，C屏幕才是大于8MB的
  - 通过看数据手册
  - 如果是8MB，那你的32，48就不能这样命名了，只能是0-31，

- sd格式化必须用命令行
  - format/q g:/fs:fat32/a:4096，g是盘符
